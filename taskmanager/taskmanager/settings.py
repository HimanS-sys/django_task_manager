...
SECRET_KEY = "django-insecure-+*me-=hdjz0#vrm@f%m1v66=2xxb#hg)1o*sf=fo6nus5jfj)!"
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DB_USER", "himanshuk"),
...
# Set up email configurations for our project
if DEBUG:
...
# Configure absolute path to store media
...
# Configuring caching using django-redis
CACHES = {
    "default" : {
